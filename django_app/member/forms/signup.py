...
class SignupForm(forms.Form):
    ...
    def clean_nickname(self):
        ...
        if nickname and MyUser.objects.filter(nickname=nickname).exists():
    ...
    def clean_slack(self):
        ...
        if slack and MyUser.objects.filter(slack=slack).exists():
    ...
    def clean_phone(self):
        ...
        if num_valid and MyUser.objects.filter(phone=phone_val).exists():
